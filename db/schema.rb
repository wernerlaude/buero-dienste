...
ActiveRecord::Schema[8.1].define(version: 2026_03_08_193219) do
  create_table "access_tokens", charset: "utf8mb4", collation: "utf8mb4_uca1400_ai_ci", force: :cascade do |t|
  ...
  create_table "bundeslands", charset: "utf8mb4", collation: "utf8mb4_uca1400_ai_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.text "info"
    t.string "name"
    t.datetime "updated_at", null: false
  ...
  create_table "links", charset: "utf8mb4", collation: "utf8mb4_uca1400_ai_ci", force: :cascade do |t|
    t.text "beschreibung"
    t.string "bezeichner"
    t.datetime "created_at", null: false
    t.boolean "online"
  ...
  create_table "offers", charset: "utf8mb4", collation: "utf8mb4_uca1400_ai_ci", force: :cascade do |t|
    t.string "card_image"
  ...
  create_table "offers_users", id: false, charset: "utf8mb4", collation: "utf8mb4_uca1400_ai_ci", force: :cascade do |t|
    t.bigint "offer_id"
    t.bigint "user_id"
  ...
  create_table "page_views", charset: "utf8mb4", collation: "utf8mb4_uca1400_ai_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "page_name"
    t.datetime "updated_at", null: false
  ...
  create_table "zip_coordinates", charset: "utf8mb4", collation: "utf8mb4_uca1400_ai_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.float "latitude"
    t.string "loc_id"
    t.float "longitude"
